...
import type { ListTestEntriesData, ListTestEntriesResponses, TestAdminData, TestAdminResponses, AuthLoginData, AuthLoginResponses, AuthLoginErrors, AuthSignupData, AuthSignupResponses, AuthSignupErrors, AuthCreateAdminData, AuthCreateAdminResponses, AuthCreateAdminErrors, AuthRefreshTokenData, AuthRefreshTokenResponses, AuthRefreshTokenErrors } from './types.gen';
...
export const authRefreshToken = <ThrowOnError extends boolean = false>(options?: Options<AuthRefreshTokenData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<AuthRefreshTokenResponses, AuthRefreshTokenErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
